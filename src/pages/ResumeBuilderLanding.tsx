...
import { 
  ...
  AmazonRiverDolphin,
  Tucuxi,
  AraguaianRiverDolphin,
  BolivianRiverDolphin,
  ChineseRiverDolphin,
  GangesRiverDolphin,
  IndusRiverDolphin,
  IrrawaddyDolphin,
  AustralianSnubfinDolphin,
  AustralianHumpbackDolphin,
  AtlanticHumpbackDolphin,
  IndianOceanHumpbackDolphin,
  PacificHumpbackDolphin,
  AmazonRiverDolphin as Boto,
  Tucuxi as TucuxiDolphin,
  AraguaianRiverDolphin as AraguaianDolphin,
  BolivianRiverDolphin as BolivianDolphin,
  ChineseRiverDolphin as ChineseDolphin,
  GangesRiverDolphin as GangesDolphin,
  IndusRiverDolphin as IndusDolphin,
  IrrawaddyDolphin as IrrawaddyDolphin,
  AustralianSnubfinDolphin as AustralianSnubfin,
  AustralianHumpbackDolphin as AustralianHumpback,
  AtlanticHumpbackDolphin as AtlanticHumpback,
  IndianOceanHumpbackDolphin as IndianOceanHumpback,
  PacificHumpbackDolphin as PacificHumpback
} from 'lucide-react';
